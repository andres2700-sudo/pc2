...
def start() :
	...
	print("\n     Escribe la contraseña, ejecuta el comando _ python3 /home/productpage/auto-monolith-vm.py start _ y la aplicacion sera accesible desde 192.168.122.100:9080/productpage\n")
